              ...
              <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
                ...
                <div className="mb-4">
                  ...
                  <button
                    ...
                    className="mt-2 w-full bg-indigo-100 hover:bg-indigo-200 text-indigo-700 font-semibold py-2 px-4 rounded-lg transition-all duration-200 text-sm"
                  >
                    ▶ Play Skeleton Preview
                  </button>
                </div>
